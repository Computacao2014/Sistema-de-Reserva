                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="card">
                                    <div class="header">
                                        <h4 class="title"> <?php echo " Olá " . $_SESSION['Nome'] . ", aqui você pode editar ou ecluir suas reservas de Laboratórios"; ?>  </h4> 
	                                    
	                                    <li>
	                                     	<a href="formEditarLaboratorio.php">
				                               <h5>Editar Reserva de Laboratórios</h3> 
				                           </a>
				                        </li> 

				                        <li>

				                             <a href="formExcluirLaboratorio.php">
				                               <h5>Exluir Reserva de Laboratórios</h3> 
				                            </a>
								        </li> 
