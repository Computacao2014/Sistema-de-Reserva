                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        $query = "SELECT  PROFESSOR.codProf, PROFESSOR.nomeProf , EQUIP_PROF.horaEmp, EQUIPAMENTO.nomeEquip, EQUIPAMENTO.cor, EQUIP_PROF.dataEmp
                                                            FROM EQUIP_PROF 
                                                            INNER JOIN PROFESSOR ON EQUIP_PROF.codProf = PROFESSOR.codProf
                                                            INNER JOIN EQUIPAMENTO ON EQUIP_PROF.codEquip = EQUIPAMENTO.codEquip WHERE EQUIP_PROF.status = 2";
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        $query2 = "SELECT  PROFESSOR.codProf, PROFESSOR.nomeProf , LAB_PROF.horaEmp, LABORATORIO.nomeLab ,LAB_PROF.dataEmp FROM LAB_PROF
                                                            INNER JOIN PROFESSOR ON LAB_PROF.codProf = PROFESSOR.codProf
                                                            INNER JOIN LABORATORIO ON LAB_PROF.codLab = LABORATORIO.codLab
                                                            WHERE LAB_PROF.status = 2";
